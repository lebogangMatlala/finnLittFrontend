...
const Component1 = () => (
    <View style={styles.componentContainer}>
        <Text>Component 1 Information</Text>
    </View>
);

const Component2 = () => (
    <View style={styles.componentContainer}>
        <Text>Component 2 Information</Text>
    </View>
);

const Component3 = () => (
    <View style={styles.componentContainer}>
        <Text>Component 3 Information</Text>
    </View>
);


export default function ModuleOneContentScreen({ navigation }) {
    ...
    const components = [ModuleOneSubOne, ModuleOneSubTwo,];
    const dropdownOptions = ['1.1. Intro to your pay slip', '1.2. How to interpret your payslip',];
    const mainTitles = ['1.1. Intro to your pay slip', '1.2. How to interpret your payslip',];
                    ...
                    >
                        <View style={styles.modalContainer}>
                            <View style={styles.modalContent}>
                                ...
                                <Text style={styles.modalText}><Text style={{ fontFamily: 'poppins-bold' }}>Congratulations</Text> on completing Module 1. You should now have a better understanding of your payslip!</Text>
                                <Text style={styles.modalText}><Text style={{ fontFamily: 'poppins-bold' }}>Module 2 </Text>centers around taxes and filing your taxes. You can continue to the next module or you can return to the homepage.</Text>
                                <View style={styles.buttonContainer}>
                                    ...
                                    <TouchableOpacity onPress={handleNoPress} style={[styles.buttonModal, { width: '45%' }]}>
                                        <Text style={styles.buttonText}>Module 2</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>

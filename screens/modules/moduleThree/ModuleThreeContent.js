...
import ModuleThreeSubOne from './components/ModuleThreeSubOne';
import ModuleThreeSubTwo from './components/ModuleThreeSubTwo';
import ModuleThreeSubThree from './components/ModuleThreeSubThree';
import ModuleTwoSubFour from '../moduleTwo/components/ModuleTwoSubFour';
import ModuleThreeSubFour from './components/ModuleThreeSubFour';
import ModuleThreeSubFive from './components/ModuleThreeSubFive';
import { useEffect } from 'react';
import AsyncStorage from '@react-native-async-storage/async-storage';



export default function ModuleThreeContentScreen({ navigation }) {
    ...
    const components = [ModuleThreeSubOne, ModuleThreeSubTwo, ModuleThreeSubThree, ModuleThreeSubFour, ModuleThreeSubFive];
    const dropdownOptions = ['3.1. What is a Credit Score', '3.2. Why is a credit score important?', '3.3. How to check what your Credit Score is', '3.4. What do I do if I have a judgement?', '3.5. How to improve my credit score',];['Option 3.1', 'Option 3.2', 'Option 3.3', 'Option 3.4', 'Option 3.5',];
    const mainTitles = ['3.1. What is a Credit Score', '3.2. Why is a credit score important?', '3.3. How to check what your Credit Score is', '3.4. What do I do if I have a judgement?', '3.5. How to improve my credit score',];
